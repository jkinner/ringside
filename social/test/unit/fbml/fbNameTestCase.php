...
class fbNameTestCase extends PHPUnit_Framework_TestCase {

   public static function providerTestFbName() {
      
      $mockUid = 12345;
      $get_userinfo_result = array( "facebook.users.getInfo"=>array( array( 'first_name'=>'John', "last_name"=>"Smith",  ) ));
    return array(
         array( $mockUid , $get_userinfo_result  , "<fb:name uid='12345' capitalize='true' reflexive='false' useyou='true'/>" , "You" ),
         array( $mockUid , $get_userinfo_result  , "<fb:name uid='345'/>" , "John Smith"),
        );
   }
   
   /**
    * @dataProvider providerTestFbName
    */   
   public function testFbName( $mockUid, $mockMethodResults, $parseString, $expected ) {
