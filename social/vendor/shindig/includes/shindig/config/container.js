...
// to share configuration.//"default",
{"gadgets.container" : ["ringside"],
...
"gadgets.features" : {
  ...
  "rpc" : {
    ...
    "parentRelayUrl" : "/social/gadgets/files/container/rpc_relay.html",
  ...
  "opensocial-0.7" : {
    ...
    "path" : "/social/gadgets/social/data",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
       "person" : ["id", "name", "thumbnailUrl", "profileUrl","currentLocation","aboutMe","status","gender","relationshipStatus","dateOfBirth","timeZone","jobs","schools","interests","music","movies","tvShows","books","quotes","turnOns","romance","lookingFor","religion","politicalViews"],
       "activity" : ["id", "title"]
    }
  }
