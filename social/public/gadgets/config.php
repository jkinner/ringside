...
// Ringside - Be more flexible in detections of install path
$shindig_root=realpath(dirname(__FILE__)) . '/../../includes/shindig';
if(!file_exists($shindig_root)){
	$shindig_root=realpath(dirname(__FILE__)) . '/../shindig';
}
if(!file_exists($shindig_root)){
	$shindig_root=realpath(dirname(__FILE__)) . '/../../vendor/shindig/includes/shindig';
}
error_log("shindig_root=$shindig_root");
$config = array(
	...
	'web_prefix' => $socialRoot,//Ringside LocalSettings.php
	...
	'features_path' => $shindig_root.'/features/',
	'container_path' =>$shindig_root.'/config/',
	'javascript_path' => $shindig_root.'/javascript/', 
	...
	'gadget_signer' => 'RingsideGadgetTokenDecoder',
...
//	'src_root'=>dirname(__FILE__).'/../../includes/shindig',
	'src_root'=>$shindig_root,// Works for developers
