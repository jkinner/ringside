 ...
 *
 */
class rsFlavorHandler {
    
   private $name;
    
   function doStartTag( $application, $parentHandler, $args ) {
   	// TODO: Make sure the author's context allows for flavor specification (i.e. default or privileged app)
		$this->name = $args['name'];
		
		$application->getFlavorContext()->startFlavor($args['name']);
   ...
   function doEndTag( $application, $parentHandler, $args ) {
      ...
      $application->getFlavorContext()->endFlavor($this->name);
