...
class fbCreateButton {
   ...
   function doBody($application, &$parentHandler, $args, $body ) {
      ...
      $onclick = isset( $args['onclick'] ) ? $args['onclick'] : null;
      
      if ( $parentHandler != null && method_exists($parentHandler, 'setButton') ) {         
         return $parentHandler->setButton( $href, $title, $onclick, $body );
      } 
   }
