...
class RingsideAppsJstestPlugin {

   public $api_key = 'jstest-api-key';
   public $secret_key = 'jstest-secret-key';
   public $call_back = 'jstest/index.php';
   public $name = 'jstest';
   public $canvas_url = 'jstest';
   public $sidenav_url = '';
   public $isdefault = 1;
