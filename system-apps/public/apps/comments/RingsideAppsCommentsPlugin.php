...
class RingsideAppsCommentsPlugin {

   public $api_key = 'comments-api-key';
   public $secret_key = 'comments-secret-key';
   public $call_back = 'comments/index.php';
   public $name = 'comments';
   public $canvas_url = 'comments';
   public $sidenav_url = '';
   public $isdefault = 1;
