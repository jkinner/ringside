...
class RingsideAppsWelcomePlugin {
   
   public $api_key = 'welcome-api-key';
   public $secret_key = 'welcome-secret-key';
   public $call_back = 'welcome/index.php';
   public $name = 'welcome';
   public $canvas_url = 'welcome';
   public $sidenav_url = '';
   public $isdefault = 1;
