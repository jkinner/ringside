...
class RingsideAppsRegisterPlugin {
   
   public $api_key = 'register-api-key';
   public $secret_key = 'register-secret-key';
   public $call_back = 'register/index.php';
   public $name = 'register';
   public $canvas_url = 'register';
   public $sidenav_url = '';
   public $isdefault = 1;
