...
class RingsideAppsAdminCommunitiesPlugin {
	public $api_key = 'admin-communities-api-key';
	public $secret_key = 'admin-communities-secret-key';
	public $call_back = 'admin-communities/index.php';
}
