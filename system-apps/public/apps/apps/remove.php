...
if(isset($app_id))
{
	$app_row = $client->api_client->users_removeApp($app_id);
	echo "<fb:success message='Success Message'>You have successfully removed the $name applciation!</fb:success>";
}

include "editapps.php";
