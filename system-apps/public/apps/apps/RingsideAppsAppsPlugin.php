...
class RingsideAppsAppsPlugin {
   
   public $api_key = 'fbappskey';
   public $secret_key = 'fbappssecret';
   public $call_back = '/ringside/apps/apps/index.php';
   public $name = 'apps';
   public $canvas_url = 'apps';
   public $sidenav_url = 'apps/index.php';
   public $isdefault = 1;
   ...
   public $mobile = 0;
   public $deployed = 0;
   public $description = "Shows apps installed by the user and allows them to browse apps.";
