...
class RingsideAppsSetupPlugin {
   
   public $api_key = 'setup-api-key';
   public $secret_key = 'setup-secret-key';
   public $callback_url = 'setup/index.php';
   public $name = 'setup';
   public $canvas_url = 'setup';
   public $sidenav_url = '';
   public $isdefault = 1;
   
   public $canvas_type = RingsideAppsCommon::CANVASTYPE_IFRAME;
