...
class RingsideAppsErrorPlugin {
   
   public $api_key = 'error-api-key';
   public $secret_key = 'error-secret-key';
   public $call_back = 'error/index.php';
   public $name = 'error';
   public $canvas_url = 'error';
   public $sidenav_url = '';
   public $isdefault = 1;
   ...
   public $mobile = 0;
   public $deployed = 0;
   public $description = "Appliction for displaying error messages.";
