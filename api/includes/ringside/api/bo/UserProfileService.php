...
abstract class Api_Bo_UserProfileService
{
    
    const DEFAULT_USERPROFILE_SERVICE  = 'Api_Bo_UserProfileServiceImpl';
	...
	public abstract function isSupported($properyName);
	
	public abstract function getProfiles(array $uids, array $domainKeys, array $propertyNames);
	
	public abstract function updateProfile($uid, $newProperties);
}
