...
abstract class Api_Bo_BetterFriendsService
{
    const DEFAULT_DOMAIN_SERVICE = 'Api_Bo_BetterFriendsServiceImpl';
	...
	public abstract function get($domain_key,$owner_uid);
  
	public abstract function add($domain_key,$owner_uid,$target_uid);
  
	public abstract function remove($domain_key,$owner_uid,$target_uid);
}
