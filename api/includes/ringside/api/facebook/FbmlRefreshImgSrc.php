...
require_once( "ringside/api/cache/CacheProviderInterface.php" );
   ...
   define ( 'DEFAULT_FBML_REFRESHIMG_CACHE', 'CacheLiteProvider' );
/**
 * fbml.refreshImgSrc
 * 
 * @author Richard Friedman
 */
class FbmlRefreshImgSrc extends Api_DefaultRest {

   public $cacheProvider = DEFAULT_FBML_REFRESHIMG_CACHE;
   public $provider = null;
   public $contentTypes = array( 'image/gif', 'image/png', 'image/jpeg', 'image/tiff', 'image/bmp');
