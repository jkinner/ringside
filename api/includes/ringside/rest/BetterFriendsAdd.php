 ...
 */
class BetterFriendsAdd extends Api_DefaultRest
{
	/**
	 * Validate Request. 
	 */
	...
	public function execute()
	{
	    ...
	    return $betterFriendsService->add($this->getRequiredApiParam('domain_key'),$this->getRequiredApiParam('owner_uid'),$this->getRequiredApiParam('target_uid'));
	}
}
