 ...
 * 
 * @apiName FriendsSearch
 * @callMethod ringside.friends.search
 * @return Array $r['friends'] = array of friend uids.
 */
class FriendsSearch extends Api_DefaultRest
{
	/**
	 * No validation rquired for FriendsSearch.
	 */
