...
require_once('m3/rest/InventoryGetNetworks.php');

class InventoryGetNetworksTestCase extends BaseM3ApiTestCase
{
    public function testGetNetworks()
    {
        $_apiCall = $this->initRest( new InventoryGetNetworks(), null);
        ...
        $this->assertArrayHasKey('id', $_results['network'][0]);
        $this->assertArrayHasKey('name', $_results['network'][0]);
    }
}
?>