...
class InventoryGetApplicationsTestCase extends BaseM3ApiTestCase
{
    public function testGetApplications()
    {
        ...
        $this->assertGreaterThan(0, count($_results['application']), "there should be at least one deployed application");
        $_app = $_results['application'][0];
