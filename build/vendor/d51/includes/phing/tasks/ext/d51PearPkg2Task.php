...
require_once 'phing/tasks/ext/task/Changelog.php';
require_once 'phing/tasks/ext/task/Dependencies.php';
require_ONCE 'phing/tasks/ext/task/PostInstall.php';
require_once 'phing/tasks/ext/task/Description.php';
require_once 'phing/tasks/ext/task/Exception.php';
require_once 'phing/tasks/ext/task/KeyedContainer.php';
require_once 'phing/tasks/ext/task/License.php';
require_once 'phing/tasks/ext/task/Maintainer.php';
require_once 'phing/tasks/ext/task/Stability.php';
require_once 'phing/tasks/ext/task/TextContainer.php';
require_once 'phing/tasks/ext/task/Version.php';
/**##@-*/
...
class d51PearPkg2Task extends Task
{
    ...
    private $_postinstalls = null;
    private $_changelogs = array();
    private $_replacements = array();
    private $_globalreplacements = array();
    ...
    public function createPostinstall() {
       $postInstall = new d51PearPkg2Task_PostInstall();
       $this->_postinstalls[] = $postInstall;
       return $postInstall;
    }
    ...
    {
        require_once 'task/Replacement.php';
        $replacement = new d51PearPkg2Task_Replacement();
        $this->_replacements[] = $replacement;
        return $replacement;
    }

    public function createGlobalReplacement() {
       require_once 'task/GlobalReplacement.php';
       $this->log( "Creating Global Replacement i think");
       $globalreplacement = new d51PearPkg2Task_GlobalReplacement();
       $this->_globalreplacements[] = $globalreplacement;
       return $globalreplacement;
    }

    public function createRelease()
    {
        require_once 'task/Release.php';
    ...
    private function _initOptions()
    {
        ...
        foreach ($this->_options['ignore'] as $key => $ignore) {
            $this->_options[$key] = $ignore->__toString();
        }
