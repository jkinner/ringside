...
require_once 'phing/tasks/ext/task/Dependencies/Extension.php';
require_once 'phing/tasks/ext/task/Dependencies/Group.php';
require_once 'phing/tasks/ext/task/Dependencies/Package.php';
require_once 'phing/tasks/ext/task/Dependencies/PHP.php';
require_once 'phing/tasks/ext/task/Dependencies/PEAR.php';
