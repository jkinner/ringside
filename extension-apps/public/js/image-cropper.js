...
YAHOO.widget.ImageCropper = function ( img, config ) {
    ...
    function _init () {
        ...
        for ( control in _controls ) {
          _self.addControl(_controls[control]);
        }
    }
    ...
    this.outerElem = function() {
        return _outerElem;
    }

    this.destroy = function () {
        _outerElem.parentNode.replaceChild(_outerElem.firstChild, _outerElem);
        _outerElem = null;
    }

    this.addControl = function (divElem) {
       if ( _initialized ) {
         _outerElem.appendChild(divElem);
       } else {
         _controls.push(divElem);
       }
    }
