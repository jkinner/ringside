...
class RingsideApiClientsRest extends FacebookRestClient {
	...
	public function users_getAppKeys($apiKey)
	{
		return $this->call_method('ringside.users.getAppKeys', array('app_api_key' => $apiKey));
	}
	
	public function users_setAppKeys($apiKey, $keys)
	{
		return $this->call_method('ringside.users.setAppKeys', array('app_api_key' => $apiKey,
